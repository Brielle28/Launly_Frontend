  ...
  return (
    <section id="Footer-Header" className=" bg-[#3A3A3A] pt-[110px] gap-[109.22px]">
      <div className="footer flex flex-col">
        <div className="footer mx-auto flex gap-[109.22px] mb-[32.41px]">
          <div>
          ...
          <nav className="footer1 flex flex-col text-[white]">
          ...
          <nav className="footer2 text-white">
            <th className="footer3 capitalize">get in touch</th>
            <div className="footer4 flex mt-[23px] gap-2">
              <img
        ...
        <span className="footer5 capitalize flex justify-center items-center text-white font-normal text-base gap-2">copyright <FaRegCopyright className="w-4 h-4" /> 2024 launly | powered by launly</span>
      </div>
    </section>
  );
};
