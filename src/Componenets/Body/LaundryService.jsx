    ...
    <section className="bg-[#F4F9FC]">
      <div className="">
        <div className=" flex flex-col ml-[160px]">
          {/* <img src="public/ele2.png " className="relative mb-"></img> */}
          <div className="w-[27.5rem] h-[16.5rem] mt-[13.75rem]">
          ...
          <p className="mt-[1.206rem] font-normal text-[#54595F] w-[327.89px]">
            Proin et ante sed lectus convallis ultricies. Vestibulum ut augue
            mi.
          </p>
      ...
      <div className="">
        <div className="w-[600.5px] h-[620.94px] mt-[180px] relative">
          ...
          <div className="bg-[white] w-[252.95px] h-[70.8px] rounded-full absolute -mt-[26rem] Boxes flex">
            ...
            <p className="w-[134.25px] ml-[1.5rem] mt-[0.1rem] font-normal text-base text-[#54595F]">
              Lorem ipsum dolor
            </p>
...
const HeroLaundryService = () => {
  return (
    <div className="flex justify-center items-center ">
      <div className="bg-[#F4F9FC] max-w-[1920px] w-full flex flex-row gap-[170px] mx-auto ">
        <HeroLeftSide />
        <HeroRightside />
      </div>
    </div>
