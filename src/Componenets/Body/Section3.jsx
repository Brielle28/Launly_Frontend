  ...
  return (
    <div className=" bg-[#F4F9FC]">
      <div className="relative">
        <img
          src="/5-1024x519.png"
          className="tiredimg1 w-[710px] h-[367.94px] ml-[10px]"
        ></img>
      </div>
      <div className="absolute -mt-[23rem] ml-[14.5rem]">
        <img
          ...
          className="tiredimg2 w-[400px] h-[480.25px]"
        ></img>
      </div>
    </div>
  );
  ...
  return (
    <div>
      <div className="flex flex-col">
        <h3 className="tiredtext1 first-line:capitalize w-[450.51px] font-bold mt-[100px] ">
          getting tired with your laundry?
        </h3>
        <span className="tiredtext w-[584px] font-normal text-[17.6px] text-[#54595F] mt-[19.03px]">
        ...
        <Button className="tiredbutton mt-[35.33px] mb-[103.88px]">Call us Now</Button>
      </div>
    </div>
  );
};
...
export const GettingTired = () => {
  return (
    <>
      <div className="tired flex bg-[#F4F9FC]">
        <LeftSide />
        <RightSide />
      </div>
    </>
