...
const Partners = () => {
    return (
        <section>
             <div className="flex flex-row gap-[20px] justify-center bg-[#E8F6FF] relative mb-[100px] mt-0">
        {PartnersArray.map((item, i) => (
          <div key={i} className="bg-[#fff] w-[300px] h-[380.23px] rounded-xl mb-[100px] Boxes mt-[100px]">
