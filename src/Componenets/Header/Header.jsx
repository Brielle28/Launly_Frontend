  ...
  return (
    ...
    <header id="masthead" itemscope="itemscope" itemtype="https://schema.org/WPHeader">
      <p className="main-title bhf-hidden" itemprop="headline">
        <a href="https://kitpro.site/launly" title="launly" rel="home">launly</a>
      </p>
      <div className="elementor elementor-277" data-elementor-type="wp-post" data-elementor-id="277">
        <div className="elementor-element elementor-element-faf4839 e-flex e-con-boxed e-con e-parent" data-id="faf4839" data-element_type="container" data-core-v316-plus="true">
          <div className="e-con-inner">
            <div className="elementor-element elementor-element-934f691 e-flex e-con-boxed e-con e-child" data-id="934f691" data-element_type="container">
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-d556389 e-con-full e-flex e-con e-child" data-id="d556389" data-element_type="container">
                  <div className="elementor-element elementor-element-b8afbee elementor-widget elementor-widget-image" data-id="b8afbee" data-element_type="widget" data-widget_type="image.default">
                ...
                <div className="elementor-element elementor-element-975d400 e-con-full e-flex e-con e-child" data-id="975d400" data-element_type="container">
                  <div className="elementor-element elementor-element-59a02f8 hfe-nav-menu__align-right hfe-submenu-icon-arrow hfe-submenu-animation-none hfe-link-redirect-child hfe-nav-menu__breakpoint-tablet elementor-widget elementor-widget-navigation-menu" data-id="59a02f8" data-element_type="widget" data-settings="...">
                    <div className="elementor-widget-container">
                      <div className="hfe-nav-menu hfe-layout-horizontal hfe-nav-menu-layout horizontal hfe-pointer__none" data-layout="horizontal" data-last-item="cta">
                        <div role="button" className="hfe-nav-menu__toggle elementor-clickable">
                        ...
                        <nav className="hfe-nav-menu__layout-horizontal hfe-nav-menu__submenu-arrow" data-toggle-icon="..." data-close-icon="..." data-full-width="yes">
                          <ul id="menu-1-59a02f8" className="hfe-nav-menu">
                            <li id="menu-item-152" className="menu-item menu-item-type-custom menu-item-object-custom parent hfe-creative-menu">
                              <a href="template-kit/home/index.html" className="hfe-menu-item">Home</a>
                            </li>
                            <li id="menu-item-153" className="menu-item menu-item-type-custom menu-item-object-custom parent hfe-creative-menu">
                              <a href="template-kit/about-us/index.html" className="hfe-menu-item">About</a>
                            </li>
                            ...
                            <li id="menu-item-155" className="menu-item menu-item-type-custom menu-item-object-custom parent hfe-creative-menu">
                              <a href="template-kit/contact-us/index.html" className="hfe-menu-item">Contact</a>
                            </li>
                          </ul>
                        </nav>
                      </div>
